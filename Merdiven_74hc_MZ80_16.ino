/********************************************************************
   ...
   Nano + 8x74HC595 ile 16 basamak ayarlanabilir sıralı aydınlatma
   2 adet IR sensör MZ80
   Max. 16 Kanal Mosfet veya Röle Kartı
...
boolean registers[17]; //ShiftRegister entegrelerimizde kayıt açma...
...
int output = 12; //Kart çıkışının high/mosfet ya da low/relay olarak ayarlanması/ sadece pro çalışmada
boolean card_out ;
...
void loop() {
  ...
  stairs_count = 16;//Ekranda basamak sayısını belirtmek için...
  ...
  //Kart çıkışını nosfet veya röle kartına göre ayarlama/ sadece pro versiyon...
